<a href="{{route('admin.assets.edit', $notification->data['video']['id'])}}" class="notification_item @if ($notification->unread()) unread_notification_item @endif" class="color_darkgrey">
  ...
  <div class="notification_description">
    ...
    @else
      Admin
    @endif
    upload a new video <span class="avenirblack">{{$notification->data['video']['title']}}</span>
  </div>
